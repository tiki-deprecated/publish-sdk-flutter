...
class TryItOutLayout extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return SafeArea(child:
      Container(
          padding: EdgeInsets.all(16.0), child: SingleChildScrollView(child:
      Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: const [
          Text("Try It Out", style: TextStyle(fontSize:32)),
          Padding(padding: EdgeInsets.all(8)),
          Padding(padding: EdgeInsets.only(left: 8), child:Text("Wallet", style: TextStyle(fontWeight: FontWeight.bold),)),
          Padding(padding: EdgeInsets.all(8)),
          WalletLayoutBtn(),
          Padding(padding: EdgeInsets.all(8)),
          OwnershipLayoutBtn(),
          ...
          ConsentLayoutBtn(),
          Padding(padding: EdgeInsets.all(8)),
          Padding(padding: EdgeInsets.only(left: 8), child: Text("Outbound Requests", style: TextStyle(fontWeight: FontWeight.bold),)),
          Padding(padding: EdgeInsets.all(8)),
